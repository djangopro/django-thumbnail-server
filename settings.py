# Django settings for thumbserver project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'thumbserv.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'cm%6fvi$!pn9$z0q4=9#k5dznob9qx#43*o9jg8y_pah!a-l^f'
